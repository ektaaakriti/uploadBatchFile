...
public class UpdateAssetBySerialNumber {
	public static void Serial() {
		connectToDb DB=new connectToDb();
		 ...
		 Properties properties = DB.getProperties();
	   	 ...
	   	 String csvFilePath =properties.getProperty("csvPathUpdateBySerialNumber");
	     int batchSize = 20;
	       ...
	       try {
	         ...
	         // String sql="insert into asset_master(System_form_Factor,System_IP_Address,OS_License_details,OS_key,Type_of_Chipset,Procured_Date,Procument_ID,Warranty_AMC,Warranty_AMC_Vendor_Name,Warrenty_AMC_From,Warrenty_AMC_To,User_ID,Department_Name,Site_Name,Sub_Department_Name,Aforesight_Agent_ID)values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	           String sql = "update asset_master set System_form_Factor=?, OS_License_details=?, OS_key=?, Type_of_Chipset=?, Procured_Date=?, Procument_ID=?, Warranty_AMC=?, Warranty_AMC_Vendor_Name=?,Warrenty_AMC_From=?,Warrenty_AMC_To=?,User_ID=?,Department_Name=?,Site_Name=?,Sub_Department_Name=?,Aforesight_Agent_ID=? where system_serial_number=?";
	           ...
	           String[] header = {"System_form_Factor","OS_License_details","OS_Key","Type_of_Chipset","Procured_Date","Procument_ID","Warranty_AMC","Warranty_AMC_Vendor_Name","Warrenty_AMC_From","Warrenty_AMC_To","User_ID","Department_Name","Site_Name","Sub_Department_Name","Aforesight_Agent_ID","system_serial_number"};
	           Review bean = null;
	           ...
	           while ((bean = beanReader.read(Review.class, header, processors)) != null) {
	               ...
	               statement.setString(16,system_serial_number);
